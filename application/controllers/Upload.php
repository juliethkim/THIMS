...
class Upload extends BaseController
{
    ...
    public function index()
    {
        ...
        $error = array('error' => ' ' );
        $this->loadViews("upload/upload_form", $this->global, $error , NULL);
    }
    
    /**
     * This function is used to upload GIS data
     */
            public function do_upload()
        {
//                $config['upload_path']          = './uploads/';
                $config['upload_path']          = 'assets/data/map_data';
                ...
                if ( ! $this->upload->do_upload('userfile'))
                {
                        ...
                        $this->global['pageTitle'] = 'MORUWASA : Dashboard';
                        $this->loadViews("upload/upload_form", $this->global, $error , NULL);
                }
                else
                {
                        $data = array('upload_data' => $this->upload->data());
                        $this->loadViews("upload/upload_success", $this->global, $data , NULL);
                }
        }
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'MORUWASA : Edit User';
