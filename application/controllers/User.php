...
class User extends BaseController
{
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'THIMS : User Listing';
...
function addRegion()
    {
            ...
            $this->loadViews("home_page", $this->global, $data, NULL);
        }
 ...
 function PDF3()
 {
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'THIMS : Edit User';
            ...
            else
            {
                ...
                else
                {
                    $userInfo = array('email'=>$email, 'password'=>getHashedPassword($password), 'roleId'=>$roleId,
                        'fname'=>ucwords($fname),'lname'=>ucwords($lname), 'mobile'=>$mobile, 'updatedBy'=>$this->vendorId, 
    ...
    function profileUpdate($active = "details")
    {
        ...
        else
        {
            ...
            $userInfo = array('fname'=>$fname, 'lname'=>$lname,  'email'=>$email, 'mobile'=>$mobile, 'updatedBy'=>$this->vendorId, 'updatedDtm'=>date('Y-m-d H:i:s'));
