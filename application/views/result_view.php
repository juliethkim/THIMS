...
<div class ='col-sm-3 ' style="padding: 20px">
  ...
  <div class="card-body">
    ...
    <h6>This hospital's category is:<td><?php echo $row['category']?></td></h6>
    
    <p class="card-text">Owned by: <td><?php echo $row['ownership_type']?></td> </p>
 
    <p class="card-text">Found at: <td><?php echo $row['region_name']?></td></p>
    
      <a href="<?php echo base_url()?>hospital_profile/<?php echo $row['id']?>" style="width: 100%" class="btn btn-primary">View the Hospital Profile</a>
  </div>
</div>
