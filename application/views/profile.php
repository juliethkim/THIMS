              ...
              <!-- general form elements -->
                ...
                <div class="box box-warning">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url() . $imagepath . strtolower(strtok($imagename," ")) . $ext; ?>" alt="User profile picture">
            ...
            <div class="col-md-5">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="<?= ($active == "")? "active" : "" ?>"><a href="#changepass" data-toggle="tab">Change Password</a></li>
                        <li class="<?= ($active == "")? "active" : "" ?>"><a href="#profile_photo" data-toggle="tab">Profile Picture</a></li>  
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="<?= ($active == "profile_photo")? "active" : "" ?> tab-pane" id="profile_photo">
