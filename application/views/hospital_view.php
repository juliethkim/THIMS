...
<div class ='col-sm-3 ' style="padding: 20px">
  ...
  <div class="card" >
    ...
    <h5> Hospital's category is :<td><?php echo $row['category']?></td></h5>
    <h5>Owned by:<td><?php echo $row['ownership_type']?></td></h5>
    <h5>Found at :<td><?php echo $row['region_name']?></td></h5>
