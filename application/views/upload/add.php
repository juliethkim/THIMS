          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="title" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('title')) ? '  ="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="regDate" value="<?php echo $this->input->post('regDate'); ?>" class="has-datepicker form-control" id="regDate" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="lastUpdationDate" value="<?php echo $this->input->post('lastUpdationDate'); ?>" class="has-datepicker form-control" id="lastUpdationDate" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="user_level" value="<?php echo $this->input->post('user_level'); ?>" class="form-control" id="user_level" />
